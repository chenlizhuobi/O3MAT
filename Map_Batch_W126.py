...
def plot_us_map(
    ...
    merged_path = os.path.join("/DeepLearning/mnt/shixiansheng/data_fusion/output", "Merged_HourlyIntoMetrics_Alone")
    try:
            ...
            for period in combination:
                ...
                # for variable in ['model', 'vna_ozone', 'evna_ozone', 'avna_ozone', 'ds_ozone']:
                    ...
                    if images:
                        ...
                        merged_image_path = os.path.join(merged_path, f"{year}_{period}_merged.png")
