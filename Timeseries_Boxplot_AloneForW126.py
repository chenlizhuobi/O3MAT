...
def plot_boxplots(data, output_dir='/DeepLearning/mnt/shixiansheng/data_fusion/output/boxplots'):
    ...
    for period in periods:
        ...
        plt.xlabel('2002 O₃ (ppm-hrs)', labelpad=15)
        plt.ylabel('2019-2002 O₃ (ppm-hrs)', labelpad=15)
...
def main():
    ...
    try:
        ...
        data_2002_path = "/DeepLearning/mnt/shixiansheng/data_fusion/output/W126_AtF/2002_W126_AtF.csv"
        data_delta_path = "/DeepLearning/mnt/shixiansheng/data_fusion/output/W126_AtF/2019-2002_W126_AtF.csv"
        ...
        # 合并和处理数据
        merged_data = merge_and_process_data(df_2002, df_delta, selected_periods=period_columns,exclude_w126=False)
