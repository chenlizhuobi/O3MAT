...
def plot_us_map(
    ...
    save_path = os.path.join("/DeepLearning/mnt/shixiansheng/data_fusion/output/AloneMap_Yearchange", f"{year}_AloneMapDelta")
    merged_path = os.path.join("/DeepLearning/mnt/shixiansheng/data_fusion/output", "Merged_DailyIntoMetrics_Yearchange")
    try:
    ...
    for period in tqdm(periods):
        ...
        for variable in variable_settings['variables']:
            ...
            title = f"2019-2002_{period_label}: {dataset_label}"
...
if __name__ == "__main__":
    ...
    file_list = ["/DeepLearning/mnt/shixiansheng/data_fusion/output/W126_AtF/2019-2002_W126_AtF.csv"]
